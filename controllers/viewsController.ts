 ...
 */
exports.getOverview = catchAsync(async (_req: Request, res: Response) => {
 ...
 * @returns {string} 200 - HTML page
 */
exports.getTourPage = catchAsync(
 ...
 * @returns {string} 200 - HTML page
 */
exports.getLoginForm = catchAsync(async (_req: Request, res: Response) => {
 ...
 * @returns {string} 200 - HTML page
 */
exports.getSignupForm = catchAsync(async (_req: Request, res: Response) => {
 ...
 * @returns {string} 200 - HTML page
 */
exports.getAccount = (_req: Request, res: Response) => {
...
exports.getMyTours = catchAsync(
  async (req: Request, res: Response, _next: NextFunction) => {
    const bookings = await Booking.find({ user: (req.user as any).id });
